...
def home(request):
    try:
        ...
        context = {'page': 'Hil Patel' ,'q1':query1 , 'q2_1':query2_1 , 'q2_2':query2_2, 'q2_3':query2_3 , 'q2_4':query2_4 , 'q2_5':query2_5, 'q2_6':query2_6, 'q2_7':query2_7, 'q2_8':query2_8, 'q3':query3 }
